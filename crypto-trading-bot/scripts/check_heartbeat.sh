...
# Run from repo root: bash scripts/check_heartbeat.sh

set -e

REPO_DIR="$(cd "$(dirname "$0")/.." && pwd)"
HEARTBEAT_FILE="$REPO_DIR/smart-ea-bot/core/logs/daemon_heartbeat.json"
ALERT_LOG="$REPO_DIR/logs/heartbeat_alerts.log"
MAX_AGE_HOURS=25
