...
Patches alpaca_trade_api BEFORE importing paper_daemon to prevent
network connections during test runs.
"""
...
# Remove alpaca_trade_api from cache so we can mock it
for mod_name in list(sys.modules.keys()):
    if 'alpaca' in mod_name.lower():
        del sys.modules[mod_name]

# Mock the module before any import
